        ...
        <div className="mb-10 md:mb-16 max-w-3xl">
          ...
          >
            ...
            <span className="text-foreground">
              From automating job applications to crafting custom software
              solutions.
            </span>
          </motion.p>
        </div>
                ...
                {activeindex !== null ? (
                      ...
                      {projects[activeindex].image ? (
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center text-muted-foreground gap-4">
                          ...
                          <p className="font-medium">
                            Preview of {projects[activeindex].title}
                          </p>
                        </div>
                      )}
                  ...
                  >
                    ...
                    <p className="text-muted-foreground max-w-xs">
                      Click on any item from the list to view project details
                      and preview the live site.
                    </p>
                  </motion.div>
                )}
              </AnimatePresence>
